      ...
      mu = 1.0d-1*beta ! Single particle energy
      ...
      call dlr_dyson_it(rank,dlrit,it2cf,it2cfpiv,cf2it,phi,mu,sigeval,&
        w,fptol,numit,1,g,info)
      ...
      do i=1,nmu
        ...
        call dlr_dyson_it(rank,dlrit,it2cf,it2cfpiv,cf2it,phi,i*mu/nmu,&
          sigeval,w,fptol,numit,0,g,info)
