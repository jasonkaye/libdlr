...
!!    * FILENAME, fhe root name of the output files.
!!
!!  Licensing:
!!
...
!  write ( *, '(a)' ) ' '
!  write ( *, '(a)' ) '  Compute a Gauss-Jacobi rule for approximating'
!  write ( *, '(a)' ) &
...
!  write ( *, '(a)' ) '  ALPHA is the exponent of (B-X)'
!  write ( *, '(a)' ) '  BETA is the exponent of (X-A):'
...
!  else
!    write ( *, '(a)' ) ' '
!    write ( *, '(a)' ) '  ALPHA is the exponent of (B-x) in the integral:'
!    write ( *, '(a)' ) '  Note that -1.0 < ALPHA is required.'
!    write ( *, '(a)' ) '  Enter the value of ALPHA:'
!    read ( *, * ) alpha
!  end if
!!
!!  Get BETA
...
!  else
!    write ( *, '(a)' ) ' '
!    write ( *, '(a)' ) '  BETA is the exponent of (x-A) in the integral:'
!    write ( *, '(a)' ) '  Note that -1.0 < BETA is required.'
!    write ( *, '(a)' ) '  Enter the value of BETA:'
!    read ( *, * ) beta
!  end if
!!
!!  Get A.
