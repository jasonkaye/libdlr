      program dlr_dyson_sc

      ! Solve nonlinear Dyson equation with Sigma = c^2*G
      ...
      ntst = 1000 ! # points at which to output solution


      ! --- Call main test subroutine ---

      call dlr_dyson_sc_main(lambda,eps,nmax,ntst,fptol,maxit,w,&
        beta,c)


      end program dlr_dyson_sc


      subroutine dlr_dyson_sc_main(lambda,eps,nmax,ntst,fptol,&
          maxit,w,beta,c)
      ...
      ! --- Solve nonlinear Dyson equation ---
      ...
      write(6,*) '-------------------- DLR error --------------------'
      write(6,*) ''
      write(6,*) 'Imag time max err = ',err1
      write(6,*) 'Mats freq max err = ',err2
      write(6,*) ''
      ...
      end subroutine dlr_dyson_sc_main
