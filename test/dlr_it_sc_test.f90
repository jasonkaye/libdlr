      ...
      ! function at DLR grid points, and then measure the error of the
      ! resulting expansion on a test grid.
      ...
      end program dlr_sc_test


      subroutine dlr_sc_test_main(lambda,eps,ntst,beta,fb)
      ...
      do i=1,rank
        ...
        call gfunsc(pg,npg,pbpg,xgl,wgl,xgj,wgj,fb,beta,dlrit(i),gdlr(i))
      ...
      end subroutine dlr_sc_test_main
