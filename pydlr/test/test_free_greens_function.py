...
class TestFreeGreensFunction(unittest.TestCase):

    def test_free_greens_function_scalar_bosonic(self, verbose=False):
        ...
        self.assertTrue(np.allclose(G_laa_free, G_laa_dlr))
        self.assertTrue(np.allclose(G_laa_free, G_laa_matfree))
        self.assertTrue(np.allclose(G_laa_free, G_laa_eval))
        self.assertTrue(np.allclose(G_laa_free, G_laa_dlrfree))

        self.assertTrue(np.allclose(G_qaa_free, G_qaa_exact))
        self.assertTrue(np.allclose(G_qaa_free, G_qaa_dlr))
        self.assertTrue(np.allclose(G_naa_eval, G_naa_exact))


    def test_free_greens_function_scalar(self, verbose=False):
        ...
        self.assertTrue(np.allclose(G_laa, G_laa_ref))
        self.assertTrue(np.allclose(G_qaa, G_qaa_ref))
        self.assertTrue(np.allclose(G_laa, g_laa))


    def test_free_greens_function_matrix(self, verbose=False):
