...
class TestDimer(unittest.TestCase):
    ...
    def test_dimer(self, verbose=False):
        ...
        self.assertTrue(np.allclose(G00_l, d.tau_from_dlr(G00_x)))
        self.assertTrue(np.allclose(G00_l, d.eval_dlr_tau(G00_x, tau_l, beta)))
