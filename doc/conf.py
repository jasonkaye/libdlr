# -*- coding: utf-8 -*-
#
# readthedocs_test documentation build configuration file, created by
...
exclude_patterns = ['_doxygen', '_build', 'Thumbs.db', '.DS_Store']
...
breathe_projects_source = { "fortran" : ("../src", ["dlr_sr.f90", "kernels.f90", "utils.f90", "dlr_dyson.f90"]) }
